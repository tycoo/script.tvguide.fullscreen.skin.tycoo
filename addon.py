...
if skin > -1:
    ...
    if tvgf:
        ...
        tvgf.setSetting('program.background.texture.url', 'special://home/addons/script.tvguide.fullscreen.skin.tycoo/resources/skins/WhiteSnowCustomFont/media/cubic_whitewallpaper2.50.jpg')
